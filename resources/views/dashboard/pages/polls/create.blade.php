                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('polls.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ old('start') }}" autocomplete="off" name="start" type="date"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ old('end') }}" autocomplete="off" name="end" type="date"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mt-4 mb-3">
                                    <textarea autocomplete="off"
                                              ...
                                              id="description"
                                              placeholder="Enter Name here">{{ old('description') }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
