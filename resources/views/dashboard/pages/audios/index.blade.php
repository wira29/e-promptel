    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <a href="{{ route('audios.create') }}" class="btn btn-primary">Tambah Data</a>
                    </div>
                    <div class="mb-2">
                        <h5 class="mb-4">Halaman Audio</h5>
                    </div>
    ...
    <script>
        $(document).ready(() => {
            ...
            $(document).on('click', '.delete-alert', function () {
                ...
                let url = `{{ route('audios.destroy', ':id') }}`.replace(':id', id);
