                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ $article->title }}" autocomplete="off" name="title" type="text"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ $article->date }}" autocomplete="off" name="date" type="date"
                                ...
                                <div class="form-floating mb-3">
                                    <select name="category_id"
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                {{ $article->category_id == $category->id ? 'selected' : '' }} value="{{ $category->id }}">
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <select name="status" class="form-control">
                                        <option
                                            {{ $article->status == ArticleStatusEnum::ACTIVE->value ? 'selected' : '' }} value="1">
                                            Publish
                                        </option>
                                        <option
                                            {{ $article->status == ArticleStatusEnum::DRAFT->value ? 'selected' : '' }} value="0">
                                            Draft
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mt-3 mb-3">
                                    <textarea id="content" rows="10" data-sample="3"
                                              ...
                                              class="form-control @error('content') is-invalid @enderror">{{ $article->content }}</textarea>
                                    @error('content')
