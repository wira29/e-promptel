...
@section('content')
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('agendas.update', $agenda) }}" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ $agenda->title }}" autocomplete="off" name="title" type="text"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ $agenda->date }}" autocomplete="off" name="date" type="date"
                                ...
                                <div class="form-floating mb-3">
                                    <select name="category_id"
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                {{ $agenda->category_id == $category->id ? 'selected' : '' }} value="{{ $category->id }}">
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <select name="status" class="form-control">
                                        <option
                                            {{ $agenda->status == ArticleStatusEnum::ACTIVE->value ? 'selected' : '' }} value="1">
                                            Publish
                                        </option>
                                        <option
                                            {{ $agenda->status == ArticleStatusEnum::DRAFT->value ? 'selected' : '' }} value="0">
                                            Draft
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-4">
                                    <img src="{{ asset('storage/' . $agenda->thumbnail) }}" alt="{{ $agenda->title }}"
                                         width="200">
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mt-3 mb-3">
                                    <textarea id="content" rows="10" data-sample="3"
                                              ...
                                              class="form-control @error('content') is-invalid @enderror">{{ $agenda->content }}</textarea>
                                    @error('content')
