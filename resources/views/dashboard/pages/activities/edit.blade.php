        ...
        <div class="card bg-primary shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8 text-white">Master Kegiatan</h4>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ $activity->title }}" autocomplete="off" name="title" type="text"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input value="{{ $activity->date }}" autocomplete="off" name="date" type="date"
                                ...
                                <div class="form-floating mb-3">
                                    <select name="category_id"
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                {{ $activity->category_id == $category->id ? 'selected' : '' }} value="{{ $category->id }}">
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <select name="status" class="form-control">
                                        <option
                                            {{ $activity->status == ArticleStatusEnum::ACTIVE->value ? 'selected' : '' }} value="1">
                                            Publish
                                        </option>
                                        <option
                                            {{ $activity->status == ArticleStatusEnum::DRAFT->value ? 'selected' : '' }} value="0">
                                            Draft
                                        </option>
                                    </select>
                                    <label for="tb-cpwd">Status Kegiatan</label>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-4">
                                    <label for="tb-cpwd">Konten Kegiatan</label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mt-3 mb-3">
                                    <textarea id="content" rows="10" data-sample="3"
                                              ...
                                              class="form-control @error('content') is-invalid @enderror">{{ $activity->content }}</textarea>
                                    @error('content')
