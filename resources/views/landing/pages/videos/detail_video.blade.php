                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    <span class="mr-10"> {{ \Carbon\Carbon::make($video->date)->format('d F Y') }}</span>
                                </div>
                            </div>
                ...
                <div class="widget-area">
                    ...
                    >
                        <div class="widget-header-1 position-relative mb-30">
                            <h5 class="mt-5 mb-30">Video Terbaru</h5>
                        </div>
                                    ...
                                    <li class="mb-30 wow fadeInUp animated">
                                        ...
                                        >
                                            <div class="post-content media-body">
                                                ...
                                                >
                                                    <a href="{{ route('landing.detail-videos', $latest->slug) }}"
                                                    >{{ $latest->title }}</a
                                                    >
                                                </h6>
                                                <div
                                            ...
                                            >
                                                <a
                                                    class="color-white"
                                                    href="{{ route('landing.detail-videos', $latest->slug) }}"
                                                >
                                                    <img
                                                        src="https://i.ytimg.com/vi/{{ $latest->link }}/hqdefault.jpg"
                                                        alt=""
                                                    />
                                                </a>
                                            </div>
