                ...
                >
                    ...
                    <div class="slide-fade">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a href="category.html"
                                            ><span
                                                class="post-cat text-success text-uppercase"
                                                >Animal</span
                                            ></a
                                        >
                                    </div>
                        ...
                        <div class="position-relative post-thumb">
                            ...
                            >
                                <a class="img-link" href="single.html"></a>
                                <span class="top-left-icon bg-danger"
                                    ><i class="elegant-icon icon_image"></i
                                ></span>
                                <div
                                    class="post-content-overlay text-white ml-30 mr-30 pb-30"
                                >
                                    ...
                                    >
                                        <a class="text-white" href="single.html"
                                            >This genius photo experiment shows
                                            we are all just sheeple in the
                                            consumer matrix</a
                                        >
                                    </h3>
                                    <div
            ...
            >
                <div class="post-card-1 border-radius-10 hover-up">
                    <div
                        ...
                        style="
                            background-image: url(assets/imgs/news/news-1.jpg);
                        "
                    >
                        <a class="img-link" href="single.html"></a>
                    ...
                    <div class="post-content p-30">
                        <div class="entry-meta meta-0 font-small mb-10">
                            ...
                            >
                            <a href="category.html"
                                ><span class="post-cat text-success"
                                    >Food</span
                                ></a
                            >
                        </div>
                        <div class="d-flex post-card-content">
                            <h5 class="post-title mb-20 font-weight-900">
                                <a href="single.html"
                                    >Want fluffy Japanese pancakes but can’t fly
                                    to Tokyo?</a
                                >
                            </h5>
                            <div
            ...
            <article class="col-lg-4 col-md-6 mb-30 wow fadeInUp animated">
                <div class="post-card-1 border-radius-10 hover-up">
                    <div
                        class="post-thumb thumb-overlay img-hover-slide position-relative"
                        style="
                            background-image: url(assets/imgs/news/news-7.jpg);
                        "
                    >
                        <a class="img-link" href="single.html"></a>
                        <ul class="social-share">
                    ...
                    <div class="post-content p-30">
                        <div class="entry-meta meta-0 font-small mb-10">
                            <a href="category.html"
                                ><span class="post-cat text-warning"
                                    >Fashion</span
                                ></a
                            >
                        </div>
                        <div class="d-flex post-card-content">
                            <h5 class="post-title mb-20 font-weight-900">
                                <a href="single.html"
                                    >Put Yourself in Your Customers Shoes</a
                                >
                            </h5>
                            <div
                                class="entry-meta meta-1 float-start font-x-small text-uppercase"
            ...
            >
                <div class="post-card-1 border-radius-10 hover-up">
                    <div
                        class="post-thumb thumb-overlay img-hover-slide position-relative"
                        style="
                            background-image: url(assets/imgs/news/news-9.jpg);
                        "
                    >
                        <a class="img-link" href="single.html"></a>
                        <ul class="social-share">
                    ...
                    <div class="post-content p-30">
                        <div class="entry-meta meta-0 font-small mb-10">
                            <a href="category.html"
                                ><span class="post-cat text-danger"
                                    >Travel</span
                                ></a
                            >
                        </div>
                        <div class="d-flex post-card-content">
                            <h5 class="post-title mb-20 font-weight-900">
                                <a href="single.html"
                                    >Life and Death in the Empire of the
                                    Tiger</a
                                >
                            </h5>
                            <div
            ...
            >
                <div class="post-card-1 border-radius-10 hover-up">
                    <div
                        class="post-thumb thumb-overlay img-hover-slide position-relative"
                        style="
                            background-image: url(assets/imgs/news/news-11.jpg);
                        "
                    >
                        <a class="img-link" href="single.html"></a>
                    ...
                    <div class="post-content p-30">
                        ...
                        <div class="d-flex post-card-content">
                            <h5 class="post-title mb-20 font-weight-900">
                                <a href="single.html"
                                    >When Two Wheels Are Better Than Four</a
                                >
                            </h5>
                            <div
                                class="entry-meta meta-1 float-start font-x-small text-uppercase"
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="widget-area">
                                    ...
                                    >
                                        ...
                                        <div class="post-content media-body">
                                            <p class="mb-10">
                                                ...
                                                >
                                                <span
                                                    class="ml-15 font-small text-muted has-dot"
                                                    >16 Jan 2023</span
                                                >
                                            </p>
                                ...
                                <li class="mb-30 wow fadeInUp animated">
                                    ...
                                    >
                                        ...
                                        <div class="post-content media-body">
                                            ...
                                            <p class="text-muted font-small">
                                                Striking pewter studded
                                                epaulettes silver zips
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="wow fadeInUp animated">
                                    ...
                                    >
                                        ...
                                        <div class="post-content media-body">
                                            ...
                                            <p class="text-muted font-small">
                                                Workwear bow detailing a
                                                slingback buckle strap
                                            </p>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div
                        class="sidebar-widget widget_instagram wow fadeInUp animated"
                    >
                        <div class="widget-header-1 position-relative mb-30">
                        ...
                        <div class="instagram-gellay">
                            <ul class="insta-feed">
                                <li>
                                    <a
                                        href="assets/imgs/thumbnail-3.html"
                                        class="play-video"
                                        data-animate="zoomIn"
                                        data-duration="1.5s"
                                        data-delay="0.1s"
                                ...
                                <li>
                                    <a
                                        href="assets/imgs/thumbnail-4.html"
                                        class="play-video"
                                        data-animate="zoomIn"
                                        data-duration="1.5s"
                                        data-delay="0.1s"
                                ...
                                <li>
                                    <a
                                        href="assets/imgs/thumbnail-5.html"
                                        class="play-video"
                                        data-animate="zoomIn"
                                        data-duration="1.5s"
                                        data-delay="0.1s"
