                                    ...
                                    <div class="row mb-40 list-style-2">
                                        <div class="col-md-4">
                                            ...
                                            >
                                                <div
                                                    ...
                                                    style="
                                                    background-image: url('{{ asset('storage/' . $activity->thumbnail ) }}');
                                                "
                                                >
                                                    <a
                                                        class="img-link"
                                                        href="{{
                                                        route('landing.detail-activities', $activity->slug)
                                                    }}"
                                                    ></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-8 align-self-center">
                                            <div class="post-content">
                                                ...
                                                >
                                                <span class="post-on"
                                                >{{ \Carbon\Carbon::make($activity->date)->format('d F Y') }}</span
                                                >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            <div class="post-content media-body">
                                                ...
                                                >
                                                    <a
                                                        href="{{
                                                        route('landing.detail-activities', $latest->slug)
                                                    }}"
                                                    >{{ $latest->title }}</a
                                                    >
                                                </h6>
