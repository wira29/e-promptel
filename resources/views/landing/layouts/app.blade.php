        ...
        <div class="sidebar-widget widget_categories mb-50 mt-30">
            ...
            <div class="widget_nav_menu">
                <ul>
                    ...
                    <li class="cat-item cat-item-6"><a href="category-big.html">Lifestyle</a> <span class="post-count">25</span>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <ul class="list-post">
                    <li class="mb-30">
                        <div class="d-flex hover-up-2 transition-normal">
                            ...
                            <div class="post-content media-body">
                                <h6 class="post-title mb-15 text-limit-2-row font-medium"><a href="single.html">The Life
                                        of a Travel Writer with David Farley</a></h6>
                    ...
                    <li class="mb-30">
                        <div class="d-flex hover-up-2 transition-normal">
                            ...
                            <div class="post-content media-body">
                                <h6 class="post-title mb-15 text-limit-2-row font-medium"><a href="single.html">The 22
                                        Best Things to See and Do in Bangkok</a></h6>
                                <div class="entry-meta meta-1 float-start font-x-small text-uppercase">
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/6518359910c0b257248731d3/1hbj92p10';
        s1.charset='UTF-8';
