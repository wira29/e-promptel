                ...
                <div class="single-content2">
                    ...
                    >
                        <iframe
                            ...
                            frameborder="no"
                            allow="autoplay"
                            src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1446394558&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"
                        ></iframe>
                        <div
                            style="
                                font-size: 10px;
                        ...
                        >
                            <a
                                href="https://soundcloud.com/ibmanggapraharjasd"
                                title="ida bagus made ap surya dinata"
                                target="_blank"
                                style="color: #cccccc; text-decoration: none"
                                >ida bagus made ap surya dinata</a
                            >
                            ·
                            <a
                                href="https://soundcloud.com/ibmanggapraharjasd/komang-raim-laode"
                                title="Komang  - Raim Laode"
                                target="_blank"
                                style="color: #cccccc; text-decoration: none"
                                >Komang - Raim Laode</a
                            >
                    ...
                    <article class="entry-wraper mb-50">
                        <div
                            class="entry-main-content dropcap wow fadeIn animated"
                        >
                            <p>
                                Thanks sniffed in hello after in foolhardy and
                                some far purposefully much one at the much
                                conjointly leapt skimpily that quail sheep some
                                goodness <a href="#">nightingale</a> the instead
                            ...
                            <p>
                                ...
                                whispered intriguingly well extensive one howled
                                talkative admonishingly below a rethought
                                overlaid dear gosh activated less however hawk
                                yet oh scratched ostrich some outside crud
                                irrespective lightheartedly and much far
                                amenably that the elephant since when.
                            </p>
                        </div>
                        <div
                            class="single-social-share clearfix wow fadeIn animated"
                        >
                            <div
                                class="entry-meta meta-1 font-small color-grey float-start mt-10"
                            >
                                <span class="hit-count mr-15"
                                    ><i
                                        class="elegant-icon icon_comment_alt mr-5"
                                    ></i
                                    >182 comments</span
                                >
                                <span class="hit-count mr-15"
                                ...
                                <span class="hit-count"
                                    ><i
                                        class="elegant-icon icon_star-half_alt mr-5"
                                    ></i
                                    >Rate: 9/10</span
                                >
                            </div>
                            <ul
                                class="header-social-network d-inline-block list-inline float-md-end mt-md-0 mt-4"
                            >
                                <li class="list-inline-item text-muted">
                                    <span>Share this: </span>
                                </li>
